...
const GAME_CONFIG = {
    ...
    ENEMIES: {
        ...
        ABOMINATION_TANK: { // New enemy type
            id: 'abomination_tank',
    ...
    WAVES: [
        ...
        },
        {
            ...
            enemies: [
                ...
                { type: 'abomination_tank', count: 1, delay: 5000 } // Intro new enemy
            ],
    ...
    HERO_STATS: {
        ...
        xpToLevel: [100, 250, 500, 1000, 1500, 2500, 4000, 6000, 9000] // XP required for level 2-10
    }
};
